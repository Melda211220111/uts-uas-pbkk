...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Kendaraan'); ?></title>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid"> <!-- Gunakan container-fluid agar navbar memiliki lebar penuh -->
                <a class="navbar-brand" href="<?php echo e(route('kendaraan.index')); ?>">Home</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto"> <!-- Gunakan ml-auto untuk memindahkan daftar navigasi ke kanan -->
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('kendaraan.index')); ?>">Kendaraan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('kwitansi.index')); ?>">Kwitansi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('penyewa.index')); ?>">Penyewa</a>
                        </li>
                    </ul>
                </div>
            </div>
...
</html><?php /**PATH C:\laragon\www\uts_kendaraan-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>