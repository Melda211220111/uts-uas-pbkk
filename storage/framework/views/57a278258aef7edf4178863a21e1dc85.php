...
<body>
    <section class="header">
        <nav>
            ...
            <div class="nav-links">
                <ul>
                    ...
                    <li class="nav-item<?php echo e(request()->is('/kendaraan') ? ' active' : ''); ?>">
        ...
        <div class="text-box">
            <h1>SEWA KENDARAAN <br>KITE</h1>
            <p>Selamat Datang di Sewa Kendaraan KITE<BR>
            ...
            <div class="social-media-icons">
                <a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox" target="_blank">
                    <img src="<?php echo e(asset('image/em.jpg')); ?>" alt="E-mail">
                </a>
                <a href="https://www.instagram.com/_aviothic.girl?igsh=MWRheTZiMnNlaGV1MA==" target="_blank">
...
</html><?php /**PATH C:\laragon\www\sewa-kendaraan\resources\views/awal/index.blade.php ENDPATH**/ ?>